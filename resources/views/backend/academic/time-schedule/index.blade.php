        ...
        <div class="table-content table-basic mt-20">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @if (hasPermission('time_schedule_create'))
                        <a href="{{ route('time_schedule.create') }}" class="btn btn-lg ot-btn-primary">
                                                    ...
                                                    @if (hasPermission('time_schedule_update'))
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('time_schedule.edit', $row->id) }}"><span
                                                                    class="icon mr-8"><i
                                                    ...
                                                    @if (hasPermission('time_schedule_delete'))
                                                        <li>
                                                            <a class="dropdown-item" href="javascript:void(0);"
                                                                onclick="delete_row('time_schedule/delete', {{ $row->id }})">
