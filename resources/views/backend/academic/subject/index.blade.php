            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @if (hasPermission('subject_create'))
                        <a href="{{ route('subject.create') }}" class="btn btn-lg ot-btn-primary">
                                                    ...
                                                    @if (hasPermission('subject_update'))
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('subject.edit', $row->id) }}"><span
                                                                    class="icon mr-8"><i
                                                    ...
                                                    @if (hasPermission('subject_delete'))
                                                        <li>
                                                            <a class="dropdown-item" href="javascript:void(0);"
                                                                onclick="delete_row('subject/delete', {{ $row->id }})">
...
@endpush
@include('backend.partials.bulk-actions-ajax', ['bulkRoute' => 'subject'])
