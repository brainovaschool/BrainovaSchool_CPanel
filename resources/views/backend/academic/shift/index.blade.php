            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @if (hasPermission('shift_create'))
                        <a href="{{ route('shift.create') }}" class="btn btn-lg ot-btn-primary">
                                            ...
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end ">
                                                    @if (hasPermission('shift_update'))
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('shift.edit', $row->id) }}"><span
                                                                    class="icon mr-8"><i
                                                    ...
                                                    @if (hasPermission('shift_update'))
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('shift.translate', $row->id) }}"><span
                                                                    class="icon mr-8"><i
                                                    ...
                                                    @if (hasPermission('shift_delete'))
                                                        <li>
                                                            <a class="dropdown-item" href="javascript:void(0);"
                                                                onclick="delete_row('shift/delete', {{ $row->id }})">
...
@endpush
@include('backend.partials.bulk-actions-ajax', ['bulkRoute' => 'shift'])
