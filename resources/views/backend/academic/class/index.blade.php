    ...
    <div class="page-content">
        ...
        <div class="table-content table-basic mt-20">
            <div class="card">
                ...
                <div class="card-body">
                    @if (hasPermission('classes_delete'))
                                        ...
                                        <td class="action">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end ">
                                                    @if (hasPermission('classes_update'))
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('classes.edit', $row->id) }}"><span
                                                                    class="icon mr-8"><i
                                                    ...
                                                    @if (hasPermission('classes_update') && env('APP_TRANSLATE'))
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('classes.translate', $row->id) }}"><span
                                                                    class="icon mr-8"><i
                                                    ...
                                                    @if (hasPermission('classes_delete'))
                                                        <li>
                                                            <a class="dropdown-item" href="javascript:void(0);"
                                                                onclick="delete_row('classes/delete', {{ $row->id }})">
...
@endpush
@include('backend.partials.bulk-actions-ajax', ['bulkRoute' => 'classes'])
