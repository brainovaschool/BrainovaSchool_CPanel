            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a href="{{ route('question-bank.index') }}">{{ ___('online-examination.question_bank') }}</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('question') is-invalid @enderror" name="question"
                                        ...
                                        placeholder="{{ ___('online-examination.enter_question') }}" value="{{ old('question') }}"
                                        required
                                    >
                                    @error('question')
                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                ...
                                <div class="col-md-12 mb-3 total_option">
                                    ...
                                    <select class="nice-select niceSelect bordered_style wide @error('total_option') is-invalid @enderror" name="total_option" id="total_option">
                                        ...
                                        @for($i = 1; $i <= 10; $i++)
                                            <option {{ old('total_option') == $i ? 'selected' : '' }} value="{{ $i }}">{{ $i }}</option>
                                        @endfor
                                    </select>
                                    @error('total_option')
                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                ...
                                <div class="col-md-12 mb-3 true_false_ans">
                                    ...
                                    <select class="nice-select niceSelect bordered_style wide @error('true_false_ans') is-invalid @enderror" name="true_false_ans">
                                        <option value="">{{ ___('online-examination.select_option') }}</option>
                                        <option {{ old('true_false_ans') == 1 ? 'selected' : '' }} value="1">{{ ___('online-examination.True') }}</option>
                                        <option {{ old('true_false_ans') == 2 ? 'selected' : '' }} value="2">{{ ___('online-examination.False') }}</option>
                                    </select>
