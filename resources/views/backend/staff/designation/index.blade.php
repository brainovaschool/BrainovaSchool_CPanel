            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @if (hasPermission('designation_create'))
                        <a href="{{ route('designation.create') }}" class="btn btn-lg ot-btn-primary">
                                                    ...
                                                    @if (hasPermission('designation_update'))
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('designation.edit', $row->id) }}"><span
                                                                    class="icon mr-8"><i
                                                    ...
                                                    @if (hasPermission('designation_delete'))
                                                        <li>
                                                            <a class="dropdown-item" href="javascript:void(0);"
                                                                onclick="delete_row('designation/delete', {{ $row->id }})">
