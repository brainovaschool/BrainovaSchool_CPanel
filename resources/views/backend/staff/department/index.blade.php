            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @if (hasPermission('department_create'))
                        <a href="{{ route('department.create') }}" class="btn btn-lg ot-btn-primary">
                ...
                <div class="card-body">
                    @if (hasPermission('department_delete') || hasPermission('department_update'))
                        ...
                        <table class="table table-bordered role-table">
                            <thead class="thead">
                                <tr>
                                    ...
                                    <th class="purchase">{{ ___('common.Manager') }}</th>
                            ...
                            <tbody class="tbody">
                                @forelse ($data['departments'] as $key => $row)
                                    <tr id="row_{{ $row->id }}">
                                        ...
                                        <td>{{ $row->name }}</td>
                                        <td>{{ @$row->manager->first_name }} {{ @$row->manager->last_name }}</td>
                                        <td>
                                                        ...
                                                        @if (hasPermission('department_update'))
                                                            <li>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('department.edit', $row->id) }}"><span
                                                                        class="icon mr-8"><i
                                                        ...
                                                        @if (hasPermission('department_delete'))
                                                            <li>
                                                                <a class="dropdown-item" href="javascript:void(0);"
                                                                    onclick="delete_row('department/delete', {{ $row->id }})">
...
@endpush
@include('backend.partials.bulk-actions-ajax', ['bulkRoute' => 'department'])
