...
<div class="page-content">
    ...
    <div class="table-content table-basic mt-20">
        <div class="card">
            ...
            <div class="card-body">
                @if (hasPermission('user_delete') || hasPermission('user_update'))
                                ...
                                <td class="action">
                                    <div class="dropdown dropdown-action">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            @endif
                                            @if(hasPermission('change_permission'))
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('user.change.permission', $row->id) }}">
                                                    <span class="icon mr-12"><i
                                                            class="fa-solid fa-key"></i></span>
                                                            <span>{{ ___('common.change permission') }}</span>
                                                        </a>
                                                    </li>
                                            @endif
                                        </ul>
...
@endpush
@include('backend.partials.bulk-actions-ajax', ['bulkRoute' => 'users'])
