        ...
        <div class="table-content table-basic mt-20">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @if (hasPermission('contact_info_create'))
                        <a href="{{ route('contact-info.create') }}" class="btn btn-lg ot-btn-primary">
                        ...
                        <table class="table table-bordered class-table">
                            ...
                            <tbody class="tbody">
                                ...
                                <tr id="row_{{ $row->id }}">
                                    ...
                                    @if ((hasPermission('contact_info_update') || hasPermission('contact_info_delete')) && $row->fees_collect_id == null)
                                        <td class="action">
                                                    ...
                                                    @if (hasPermission('contact_info_update'))
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('contact-info.edit', $row->id) }}"><span
                                                                    class="icon mr-8"><i
                                                                        class="fa-solid fa-pen-to-square"></i></span>
                                                                {{ ___('common.edit') }}</a>
                                                        </li>
                                                    @endif
                                                    @if (hasPermission('contact_info_update') && app_translate())
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('contact-info.translate', $row->id) }}"><span
                                                                    class="icon mr-8"><i
                                                                        class="fa-solid fa-globe"></i></span>
                                                                {{ ___('common.translate') }}</a>
                                                        </li>
                                                    @endif
                                                    @if (hasPermission('contact_info_delete'))
                                                        <li>
                                                            <a class="dropdown-item" href="javascript:void(0);"
                                                                onclick="delete_row('contact-info/delete', {{ $row->id }})">
