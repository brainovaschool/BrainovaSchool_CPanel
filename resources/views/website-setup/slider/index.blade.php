            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @if (hasPermission('slider_create'))
                        <a href="{{ route('slider.create') }}" class="btn btn-lg ot-btn-primary">
                ...
                <div class="card-body">
                    @if (hasPermission('slider_delete') || hasPermission('slider_update'))
                                        ...
                                        <td class="action">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end ">
                                                    @if (hasPermission('slider_update'))
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('slider.edit', $row->id) }}"><span
                                                                    class="icon mr-8"><i
                                                    ...
                                                    @if (hasPermission('slider_update') && app_translate())
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('slider.translate', $row->id) }}"><span
                                                                    class="icon mr-8"><i
                                                    ...
                                                    @if (hasPermission('slider_delete'))
                                                        <li>
                                                            <a class="dropdown-item" href="javascript:void(0);"
                                                                onclick="delete_row('slider/delete', {{ $row->id }})">
...
@endpush
@include('backend.partials.bulk-actions-ajax', ['bulkRoute' => 'slider'])
