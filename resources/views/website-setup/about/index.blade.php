        ...
        <div class="table-content table-basic mt-20">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @if (hasPermission('about_create'))
                        <a href="{{ route('about.create') }}" class="btn btn-lg ot-btn-primary">
                ...
                <div class="card-body">
                    @if (hasPermission('about_delete') || hasPermission('about_update'))
                                                    ...
                                                    @if (hasPermission('about_update'))
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('about.edit', $row->id) }}"><span
                                                                    class="icon mr-8"><i
                                                                        class="fa-solid fa-pen-to-square"></i></span>
                                                                {{ ___('common.edit') }}</a>
                                                        </li>
                                                    @endif
                                                    @if (hasPermission('about_update') && app_translate())
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('about.translate', $row->id) }}"><span
                                                                    class="icon mr-8"><i
                                                                        class="fa-solid fa-globe"></i></span>
                                                                {{ ___('common.translate') }}</a>
                                                        </li>
                                                    @endif
                                                    @if (hasPermission('about_delete'))
                                                        <li>
                                                            <a class="dropdown-item" href="javascript:void(0);"
                                                                onclick="delete_row('abouts/delete', {{ $row->id }})">
...
@endpush
@include('backend.partials.bulk-actions-ajax', ['bulkRoute' => 'abouts'])
