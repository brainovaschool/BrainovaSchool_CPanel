        ...
        <div class="table-content table-basic mt-20">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @if (hasPermission('counter_create'))
                        <a href="{{ route('counter.create') }}" class="btn btn-lg ot-btn-primary">
                ...
                <div class="card-body">
                    @if (hasPermission('counter_delete') || hasPermission('counter_update'))
                        ...
                        <table class="table table-bordered class-table">
                            <thead class="thead">
                                <tr>
                                    ...
                                    <th class="purchase">{{ ___('common.total_count') }}</th>
                            ...
                            <tbody class="tbody">
                                ...
                                <tr id="row_{{ $row->id }}">
                                    ...
                                    @if ((hasPermission('counter_update') || hasPermission('counter_delete')) && $row->fees_collect_id == null)
                                        <td class="action">
                                                    ...
                                                    @if (hasPermission('counter_update'))
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('counter.edit', $row->id) }}"><span
                                                                    class="icon mr-8"><i
                                                                        class="fa-solid fa-pen-to-square"></i></span>
                                                                {{ ___('common.edit') }}</a>
                                                        </li>
                                                    @endif
                                                    @if (hasPermission('counter_update') && app_translate())
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('counter.translate', $row->id) }}"><span
                                                                    class="icon mr-8"><i
                                                                        class="fa-solid fa-globe"></i></span>
                                                                {{ ___('common.translate') }}</a>
                                                        </li>
                                                    @endif
                                                    @if (hasPermission('counter_delete'))
                                                        <li>
                                                            <a class="dropdown-item" href="javascript:void(0);"
                                                                onclick="delete_row('counter/delete', {{ $row->id }})">
...
@endpush
@include('backend.partials.bulk-actions-ajax', ['bulkRoute' => 'counter'])
