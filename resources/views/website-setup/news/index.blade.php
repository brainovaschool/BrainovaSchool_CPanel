        ...
        <div class="table-content table-basic mt-20">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @if (hasPermission('news_create'))
                        <a href="{{ route('news.create') }}" class="btn btn-lg ot-btn-primary">
                ...
                <div class="card-body">
                    @if (hasPermission('news_delete') || hasPermission('news_update'))
                        ...
                        <table class="table table-bordered class-table">
                            ...
                            <tbody class="tbody">
                                ...
                                <tr id="row_{{ $row->id }}">
                                    ...
                                    @if ((hasPermission('news_update') || hasPermission('news_delete')) && $row->fees_collect_id == null)
                                        <td class="action">
                                                    ...
                                                    @if (hasPermission('news_update'))
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('news.edit', $row->id) }}"><span
                                                                    class="icon mr-8"><i
                                                                        class="fa-solid fa-pen-to-square"></i></span>
                                                                {{ ___('common.edit') }}</a>
                                                        </li>
                                                    @endif
                                                    @if (hasPermission('news_update')  && app_translate())
                                                            <li>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('news.translate', $row->id) }}"><span
                                                                        class="icon mr-8"><i
                                                    ...
                                                    @if (hasPermission('news_delete'))
                                                        <li>
                                                            <a class="dropdown-item" href="javascript:void(0);"
                                                                onclick="delete_row('admin-news/delete', {{ $row->id }})">
...
@endpush
@include('backend.partials.bulk-actions-ajax', ['bulkRoute' => 'admin-news'])
